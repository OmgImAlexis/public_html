...
function resize_img($photo_name, $owner){
    ...
    $return = '<a class="img_no_link" href="view.php?photo_name='.$photo_name.'"><img width="'.$return['width'].'" height="'.$return['height'].'" src="photos/'.$owner.'/'.$photo_name.'"></a>';
    return $return;
}
